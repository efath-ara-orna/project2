...
<body>
 <div class="limiter">
        <div class="container-login100" style="background-image: url('images/Bench-Background-48-1600x1000.jpg');">
                ...
                Parents Registration Form
                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                         ...
                         <div class="form-group row">
                            <label for="std_id" class="col-md-4 col-form-label text-md-right" style="color: white">{{ __('Email') }}</label>

                            <div class="col-md-6">
                                <input id="email" type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" placeholder="Your Email ID" required>
                        ...
                        <div class="form-group row">
                         ...
                         <div class="form-group row">
                            <div class="col-md-6">
                                <input  value='parents' type="text" class="form-control" name="role" hidden>
                            </div>
                        </div>
                         <div class="form-group row">
                            <div class="col-md-6">
                                <input  value='0' type="text" class="form-control" name="status" hidden>
                            </div>
                        </div>
  ...
  <a href="{{ url('/login') }}"><u style="color: red"> Click here to login</u></a>
  <br>
                </div>
            </div>
        </div>
